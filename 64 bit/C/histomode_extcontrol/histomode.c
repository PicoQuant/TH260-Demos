/************************************************************************
  ...
  Demo access to TimeHarp 260 Hardware via TH260LIB v 3.0
...
int main(int argc, char* argv[])
{
 ...
 printf("\nTimeHarp 260 TH260Lib Demo Application    M. Wahl, PicoQuant GmbH, 2015");
 printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
 ...
 { 
		...
		if(meascontrol==MEASCTRL_C1_GATE)
