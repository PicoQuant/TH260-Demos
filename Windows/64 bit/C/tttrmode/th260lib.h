/* Functions exported by the TimeHarp 260 programming library HHLib
...
extern int _stdcall TH260_GetSyncPeriod(int devidx, double* period);                            //new in v 1.1     seconds
...
extern int _stdcall TH260_GetHardwareDebugInfo(int devidx, char *debuginfo);                    //new in v 1.1     max 16384 characters
...
extern int _stdcall TH260_SetMarkerHoldoffTime(int devidx, int holdofftime);                    //new in v 1.1     nanoseconds
