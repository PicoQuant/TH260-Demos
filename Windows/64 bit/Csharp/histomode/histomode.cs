...
/************************************************************************
  ...
  C# demo access to TimeHarp 260 Hardware via TH260LIB v 1.1.
...
class HistoMode 
{
	...
	const string TargetLibVersion ="1.1"; //this is what this program was written for
	...
	static void Main() 
	{
		...
		Console.WriteLine ("TimeHarp 260     TH260Lib Demo Application    M. Wahl, PicoQuant GmbH, 2013");
		Console.WriteLine ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
