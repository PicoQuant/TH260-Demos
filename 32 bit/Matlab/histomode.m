...
fprintf('\nTimeHarp 260 TH260Lib Demo Application             PicoQuant 2015\n');
...
if (~libisloaded('TH260lib'))    
    ...
    loadlibrary('th260lib.dll', 'th260lib.h', 'alias', 'TH260lib');
else
